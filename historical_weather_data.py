...
https://open-meteo.com/en/docs/historical-weather-api?csv_coordinates=dewsbury&latitude=53.6946601&longitude=-1.6313262&start_date=2021-05-01&hourly=temperature_2m,relative_humidity_2m,precipitation,rain,snowfall,wet_bulb_temperature_2m&end_date=2025-08-04&temporal_resolution=native
...
params = {
	...
	"end_date": "2025-08-04",
	"hourly": ["temperature_2m", "relative_humidity_2m", "precipitation", "rain", "snowfall", "wet_bulb_temperature_2m"],
...
hourly_wet_bulb_temperature_2m = hourly.Variables(5).ValuesAsNumpy()
